...
namespace APIFATECForms.Conversion
{
    public class Shape2Sql 
    {

        APIFATECEntities db = new APIFATECEntities();
        public  void Convert(string shapefile, string connectionString, string tableName)
        {

            //arrumar esse metodo para conseguir cadastrar usando o entityframework
            int srid = 0;
            string targetProjectionWKT = null;
        ...
        public static string GenerateCreateTableQuery(ShapefileDataReader reader, string tableName)
        {
        ...
        public class ShapefileBulkSqlReader : IDataReader
        {
            #region - Fields -
